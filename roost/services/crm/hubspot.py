...
logger = logging.getLogger("roost.services.crm.hubspot")
...
class HubspotProvider(CrmProvider):
    ...
    def append_note(self, *, person_id=None, deal_id=None, content: str, title=None):
        body: dict[str, Any] = {
            "properties": {
                ...
                "hs_timestamp": datetime.utcnow().isoformat(timespec="seconds") + "Z",
            },
        }
        associations = []
        if person_id:
    ...
    def log_communication(self, *, person_id: str, channel: str, direction: str,
        ...
        ts_iso = (occurred_at or datetime.utcnow()).isoformat(timespec="seconds") + "Z"
