...
(see `roost/extras/property_agent/services/iras_stamp_duty.py`) — no IRAS account, no portal.
"""
...
logger = logging.getLogger("roost.extras.property_agent.mcp.tools_iras")
